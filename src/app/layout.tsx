...
export const metadata: Metadata = {
  ...
  keywords: ['Royal Massage Spa', 'Massage Center', 'Massage Spa', 'Massage Therapy', 'Relaxation', 'Wellness', 'Deep Tissue Massage', 'Swedish Massage', 'Hot Stone Massage', 'Body Massage', 'Therapeutic Massage'],
  openGraph: {
